        ...
        <Paper className={classes.container}>
            <Grid container direction="column">
                <Grid item container direction="row" justify="space-around" alignItems="center" className={classes.gridcontainers}>
                    <Grid item className={classes.sectionTitle}> <CallRoundedIcon color="primary"  style={{fontSize:50, color: 'teal'}}/> <Typography variant="h5">(+33) 07 58 55 18 25</Typography> </Grid>
                    <Grid item className={classes.sectionTitle}> <EmailRoundedIcon color="primary" style={{fontSize:50, color: 'teal'}}/> <Typography variant="h5">dankokonate@gmail.com</Typography> </Grid>
                    <Grid item className={classes.sectionTitle}> <LocationOnRoundedIcon color="primary" style={{fontSize:50, color: 'teal'}}/> <Typography variant="h5">Evry (91)</Typography> </Grid>
                </Grid>
                <Divider />
